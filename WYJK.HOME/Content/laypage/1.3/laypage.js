...
function () {
    ...
    f.prototype.view = function () {
        ...
        for (c.groups > c.pages && (c.groups = c.pages), e.index = Math.ceil((c.curr + (c.groups > 1 && c.groups !== c.pages ? 1 : 0)) / (0 === c.groups ? 1 : c.groups)), c.curr > 1 && c.prev && d.push('<li><a href="javascript:;" class="laypage_prev" data-page="' + (c.curr - 1) + '">' + c.prev + "</a></li>"), e.index > 1 && c.first && 0 !== c.groups && d.push('<li><a href="javascript:;" class="laypage_first" data-page="1"  title="&#x9996;&#x9875;">' + c.first + "</a><span>&#x2026;</span></li>"), e.poor = Math.floor((c.groups - 1) / 2), e.start = e.index > 1 ? c.curr - e.poor : 1, e.end = e.index > 1 ?
        function () {
            var a = c.curr + (c.groups - e.poor - 1);
            return a > c.pages ? c.pages : a
        }() : c.groups, e.end - e.start < c.groups - 1 && (e.start = e.end - c.groups + 1) ; e.start <= e.end; e.start++) e.start === c.curr ? d.push('<li class="active" ><a href="#">' + e.start + "</a></li>") : d.push('<li><a href="javascript:;" data-page="' + e.start + '">' + e.start + "</a></li>");
        ...
        (c.curr !== c.pages && c.next || e.flow) && d.push(function () {
            return e.flow && c.curr === c.pages ? '<span class="page_nomore" title="&#x5DF2;&#x6CA1;&#x6709;&#x66F4;&#x591A;">' + c.next + "</span>" : '<li><a href="javascript:;" class="laypage_next" data-page="' + (c.curr + 1) + '">' + c.next + "</a></li>"
        }()),
        '<div class="text-center"><nav><ul name="laypage' + a.v + '" class="pagination" id="laypage_' + b.config.item + '">' + d.join("") +
        function () {
