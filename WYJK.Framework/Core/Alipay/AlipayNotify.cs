...
namespace WYJK.Framework
{
    ...
    public class AlipayNotify
    {
        ...
        public AlipayNotify(AlipayConfig config)
        {
            _config = config;
        }
        /// <summary>
        ...
        public bool Verify(SortedDictionary<string, string> inputPara, string notifyId, string sign)
        {
            ...
            if (string.IsNullOrWhiteSpace(notifyId) == false)
            {
        ...
        {
            string veryfyUrl = HttpsVeryfyUrl + "partner=" + _config.Partner + "&notify_id=" + notify_id;
        ...
        /// <returns></returns>
        public static string SignByMd5(string prestr, string key, string inputCharset)
        {
        ...
        /// <returns>验证结果</returns>
        public static bool VerifyByMd5(string prestr, string sign, string key, string inputCharset)
        {
            string mysign = SignByMd5(prestr, key, inputCharset);
            return (mysign == sign);
        }
    }
}
