...
namespace WYJK.Framework
{
    ...
    internal class AlipayCore
    {
        ...
        public static SortedDictionary<string, string> FilterPara(SortedDictionary<string, string> dicArrayPre)
        {
            ...
            {
                if ("sign".Equals(temp.Key, StringComparison.OrdinalIgnoreCase) == false && "sign_type".Equals(temp.Key, StringComparison.OrdinalIgnoreCase) == false &&
                   string.IsNullOrEmpty(temp.Value) == false)
                {
